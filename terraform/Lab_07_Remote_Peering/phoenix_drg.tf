...
data "oci_core_drg_attachments" "PHX-NP-LAB06-DRG-ATTCH-01" {
    provider                    = oci.phoenix
	compartment_id              = var.compartment_id
	drg_id                      = oci_core_drg.PHX-NP-LAB06-DRG-01.id
}
...
#    drg_id                      = oci_core_drg.PHX-NP-LAB06-DRG-01.id
#    display_name                = "PHX-NP-LAB07-ATTCH-VPN-01"
#    drg_route_table_id          = oci_core_drg_route_table.PHX-NP-LAB07-RT-VPN-01.id
#}
...
#    drg_id                      = oci_core_drg.PHX-NP-LAB06-DRG-01.id
#    display_name                = "PHX-NP-LAB07-ATTCH-RPC-01"
